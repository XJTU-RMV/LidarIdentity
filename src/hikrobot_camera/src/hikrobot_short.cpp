...
int main(int argc, char **argv)
{
    ...
    //********** rosnode init **********/
    ros::init(argc, argv, "hikrobot_short");
    ros::NodeHandle hikrobot_short;
    camera::Camera MVS_cap(hikrobot_short);
    //********** rosnode init **********/
    image_transport::ImageTransport main_cam_image(hikrobot_short);
    image_transport::CameraPublisher image_pub = main_cam_image.advertiseCamera("/hikrobot_short/rgb", 1000);
