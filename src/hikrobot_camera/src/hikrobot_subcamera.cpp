...
int main(int argc, char **argv)
{
    ...
    //********** rosnode init **********/
    ros::init(argc, argv, "hikrobot_subcamera");
    ros::NodeHandle hikrobot_subcamera;
    camera::Camera MVS_cap(hikrobot_subcamera);
    //********** rosnode init **********/
    image_transport::ImageTransport main_cam_image(hikrobot_subcamera);
    image_transport::CameraPublisher image_pub = main_cam_image.advertiseCamera("/hikrobot_subcamera/rgb", 1000);
