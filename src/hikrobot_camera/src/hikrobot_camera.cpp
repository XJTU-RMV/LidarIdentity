...
int main(int argc, char **argv)
{
    ...
    string publish_name="";
    if(MVS_cap.nodename==0)publish_name="/hikrobot_camera/rgb";
    else publish_name="/hikrobot_camera/rgb";
    image_transport::CameraPublisher image_pub = main_cam_image.advertiseCamera(publish_name, 1000);
